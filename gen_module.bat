...
set module_group=-DgroupId=info.ideaworlds.server
set module_artifact=-DartifactId=%moduleName%
set module_version=-Dversion=1.0-SNAPSHOT
set module_package=-Dpackage=info.ideaworlds.server.%packageName%
set module_sample=-Dsample=%sampleName%
set module_project=-Dproject=idea-worlds-server
